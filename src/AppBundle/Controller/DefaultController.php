    ...
    public function firstAction(Request $request, $number)
    {
        ...
        if($number==1){
            $form = $this->createFormBuilder($client)
                ...
                ->add('enfant_age', ChoiceType::class, array('placeholder' => 'Choisissez', 'choices' => array('placeholder' => false, "0-5 ans"=>0, "6-11 ans"=>1, "12-15 ans"=>2, "16-18 ans"=>3, "Plus de 18 ans"=>4)))
                ->add('situation', ChoiceType::class, array('placeholder' => 'Choisissez', 'choices' => array('placeholder' => false, "Célibataire"=>0, "En couple"=>1, "Marié(e) / Pacsé(e)"=>2, "Séparé/Divorcé"=>3, "Famille recomposée"=>4)))
