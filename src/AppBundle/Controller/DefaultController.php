        ...
        if($number==1){
            $form = $this->createFormBuilder($client)
                ...
                ->add('sexe', ChoiceType::class, array('choices' => array("Un homme" =>0,"Une femme"=>1),
                    'choices_as_values' => true,'multiple'=>false,'expanded'=>true,'required' => true,'data' => ''))
                ->add('age', ChoiceType::class, array('choices' => array("Moins de 25 ans"=>0, "de 25 à 34 ans"=>1, "de 35 à 44 ans"=>2, "de 45 à 54 ans"=>3, "55 et plus"=>4),'required' => true,'data' => ''))
                ->add('profession', ChoiceType::class, array('choices' => array("Apprenti"=>0, "Ouvrier"=>1, "Employé ou technicien"=>2, "cadre"=>3, "Autre"=>4),'required' => true,'data' => ''))
                ->add('enfant', ChoiceType::class, array('choices' => array("Oui"=>0, "Non"=>1),
                    'choices_as_values' => true,'multiple'=>false,'expanded'=>true,'required' => true,'data' => ''))
                ->add('enfant_age', ChoiceType::class, array('choices' => array("0-5 ans"=>0, "6-11 ans"=>1, "12-15 ans"=>2, "16-18 ans"=>3, "Plus de 18 ans"=>4),'required' => false,'data' => ''))
                ->add('situation', ChoiceType::class, array('choices' => array("Célibataire"=>0, "En couple"=>1, "Marié(e) / Pacsé(e)"=>2, "Séparé/Divorcé"=>3, "Famille recomposée"=>4),'required' => true,'data' => ''))
