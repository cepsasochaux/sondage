    ...
    public function firstAction(Request $request, $number)
    {
        ...
        if($number==1){
            $form = $this->createFormBuilder($client)
                ...
                ->add('profession', ChoiceType::class, array('choices' => array('placeholder' => 'Choose an option', "Apprenti"=>0, "Ouvrier"=>1, "Employé ou technicien"=>2, "cadre"=>3, "Autre"=>4),'required' => true,'data' => 'null'))
